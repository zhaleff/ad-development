...
function Field({ error, className, ...props }) {
  return (
    ...
    className={clsx(
      ...
      error ? 'border-red-500/40 focus:border-red-500/60' : 'border-white/8 focus:border-[#e8ff47]/30 focus:bg-white/[0.06]',
      className
    )}
    {...props}
    />
...
export default function Submit() {
  ...
  return (
    ...
    <h1 className="text-3xl sm:text-4xl font-bold tracking-tight text-white leading-tight">Share your setup</h1>
    ...
    <div>
    <Label><FontAwesomeIcon icon={faPalette} className="mr-2 opacity-50" />Color palette</Label>
    ...
    <p className="text-center text-[11px] text-white/15 mt-3">Your submission will be reviewed before appearing publicly.</p>
    </div>
    </form>
    </div>
  )
